...
You should have a function named generateArray that uses the generateElement function to return an array containing five random integers.
You should have a function named generateContainer that creates and returns an empty div element.
